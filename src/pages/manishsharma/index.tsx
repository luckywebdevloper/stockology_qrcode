      ...
      <main className={styles.main}>
        <div className="cover">
          <div className="top">
            ...
            <div className="username">Manish Sharma</div>
            <div className="link">
              <Link href={"tel:+91 8602755337"}>
          ...
          <div className="social">
            ...
            <div className="link-box">
              <Link href={"mailto:manish.sharma@stockologysecurities.com"}>
                <div className="box">
                  <Image className="button twitter" src={mailW} alt="mail" />
                  <h4>manish.sharma@stockologysecurities.com</h4>
                </div>
                <p>Email</p>
              </Link>
            </div>{" "}
